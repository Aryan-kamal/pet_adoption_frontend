...
function Product() {
	...
	return (
		<div className="container mt-5">
			...
			<div className="mb-4">
				<button
					className="btn btn-tshirt"
					onClick={() => handleFilter("Tshirt")}
				>
					Tshirt
				</button>
				<button className="btn btn-cup" onClick={() => handleFilter("Cup")}>
					Cup
				</button>
				<button className="btn btn-food" onClick={() => handleFilter("Food")}>
					Food
				</button>
				<button
					className="btn btn-shampoo"
					onClick={() => handleFilter("Shampoo")}
				>
					Shampoo
				</button>
				<button
